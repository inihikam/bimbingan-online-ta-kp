    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-bg">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="fas fa-edit"></i> Logbook </a>
        </nav>
        ...
        <div class="table-container">
            <table class="table table-bordered">
                <thead class="table-header">
                    ...
                    <th>Bab Terakhir Bimbingan</th>
                    <th>Status</th>
                    <th>Aksi</th>
                </thead>
                <tr>
                    <td><center>1</center></td>
                    <td><center>30 April 2024</center></td>
                    <td>Membahas coding</td>
                    <td><center>30 April 2024</center></td>
                    <td><center>ACC</center></td>
                    <td><center><button type="edit" class="btn btn-warning me-2">Edit</button></center></td>
                </tr>
            </table>
        </div>  
    </div>
