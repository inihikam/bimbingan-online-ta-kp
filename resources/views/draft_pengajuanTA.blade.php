...
<head>
    ...
    <title>Draft Pengajuan TA</title>
</head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-bg">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="fas fa-edit"></i> Draft Pengajuan Tugas Akhir </a>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <div class="table-container">
            <table class="table table-bordered">
                ...
                <tr>
                    <td>24 April 2024 10:47 WIB</td>
                    <td>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae, quod debitis quis possimus impedit dolores iusto molestias accusantium</td>
                </tr>
                <tr>
                    <td>25 April 2024 10:47 WIB</td>
                    <td>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae, quod debitis quis possimus impedit dolores iusto molestias accusantium</td>
                </tr>
            </table>
        </div>
