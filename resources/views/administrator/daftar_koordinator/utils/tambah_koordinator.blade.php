<div class="modal fade" id="dialogTambahKoordinator" tabindex="-1" aria-labelledby="dialogTambahKoordinator" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="dialogTambahKoordinator">Tambah Data Koordinator</h5>
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <form method="POST" action="{{ route('data-koordinator-add') }}" enctype="multipart/form-data">
                        @csrf
