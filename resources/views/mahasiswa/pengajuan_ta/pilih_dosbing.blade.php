...
<div class="container">
    ...
    <div class="tab-content">
        <div id="nav-tab-dosbing" class="tab-pane fade show active">
                    ...
                    <table class="table table-bordered mb-1">
                        ...
                        <tr>
                            ...
                            <td class="centered-column">
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#pilihDosbingModal"><i class="fas fa-chevron-circle-right"></i></button>
                            </td>
                        </tr>
                        @endforeach
                    </table>
                ...
                <div class="table-container">
                    <table class="table table-bordered">
                        ...
                        <tr id="dosen-dipilih">
                            ...
                            <td id="nama"></td>
                            <td class="centered-column"><button type="button" class="btn btn-danger" id="hapusDosenBtn"><i class="fas fa-trash" data-bs-toggle="modal" data-bs-target="#hapusDosbingModal"></i></button></td>
                        </tr>
                    </table>
                </div>
            ...
            <!-- Modal Pilih Dosbing -->
            <div class="modal fade" id="pilihDosbingModal" tabindex="-1" aria-labelledby="pilihDosbingModalLabel" aria-hidden="true" data-npp="" data-nama="">
