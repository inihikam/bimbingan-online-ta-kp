                    ...
                    <div class="table-container">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="centered-column">April</td>
                                <td class="centered-column">1 April 2024 - 30 April 2024</td>
                                <td class="centered-column"><button type="button" class="btn btn-danger"><i
                                            class="fas fa-trash" data-bs-toggle="modal"
                                            data-bs-target="#hapusJadwalModal"></i></button></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="form-group row mb-3 justify-content-end">
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary"><i
                                    class="fas fa-chevron-right"></i>Lanjutkan</button>
                        </div>
                    </div> --}}
                </div>
