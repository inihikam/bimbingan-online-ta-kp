...
@section('content')
    <div class="container">
        ...
        @if($mahasiswa->foto)
            <div class="text-center mb-4">
                <img src="{{ asset('storage/' . $mahasiswa->foto) }}" alt="Foto Profil" class="profile-pic"
                     id="profile-pic">
            </div>
        @endif
        ...
        <div class="card">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary mt-4" onclick="openUploadPopup()">Unggah Foto Profil
                </button>
    ...
    <script>
        ...
        document.getElementById('upload-form').addEventListener('submit', function (e) {
            ...
            fetch("{{ route('mahasiswa-upload-foto') }}", {
                method: 'POST',
                body: formData,
                headers: {
